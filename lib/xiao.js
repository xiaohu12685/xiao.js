...
state.root = document.getElementById('root')?state.xmldata(document.getElementById('root')):console.error('You need to create a node with an id of root on the page');